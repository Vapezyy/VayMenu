...
using System;
using UnityEngine;  // To jest kluczowe, aby mieć dostęp do GameObject i innych klas Unity
using System.IO;
...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void Prefix()
        {
            try
            {
                GameObject imageGameObject = new GameObject("ShowImageObject");
                imageGameObject.AddComponent<StupidTemplate.UI.ShowImage>();
                DontDestroyOnLoad(imageGameObject);
            }
            catch (Exception exc)
            {
                UnityEngine.Debug.LogError($"Error during Prefix: {exc.Message}");
            }
            GameObject imageObject = new GameObject("ShowImageObject");
            imageObject.AddComponent<StupidTemplate.UI.ShowImage>();
